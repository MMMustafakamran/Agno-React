...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/agno/intelligence/quickstart), then send a message and confirm that it appears in [Rich Threads](/agno/threads). Open your project in [CopilotKit Intelligence](https://dashboard.operations.copilotkit.ai/) and confirm that Learning is available.
