...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/agno/intelligence/quickstart#set-it-up-manually) to connect your existing app and configure server-side user identity.
  </Step>
