...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/agno/intelligence/quickstart#set-it-up-manually). That page signs you in with the CLI, selects the project, and configures server-side user identity. Your existing app and agent stay in place.
  </Step>
...
- **Threads:** [Threads & Persistence Architecture](/agno/intelligence/threads-explained), the
  persistence model for a single conversation
- **Platform:** [CopilotKit Intelligence](/agno/intelligence/overview), where
  memory sits among the other pillars
- **Self-hosting:** [Self-hosting Intelligence](/agno/intelligence/self-hosting),
