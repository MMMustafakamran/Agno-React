...
<Steps>
  ...
  <Step>
    ...
    For another server, use the [runtime adapter guide](/agno/runtime-server-adapter#multi-route-vs-single-route).
  </Step>
  ...
  <Step>
    ### Confirm the connection
      ...
      If Home does not show **Intelligence connected**, or Threads is locked, the setup is incomplete. Follow the action shown in Inspector or review the [Inspector setup states](/agno/inspector#project-context-and-usage).
