...
<Callout type="info">
  Start with [Automatic Learning](/agno/learning) to collect threads, configure daily runs, and review skills. Before connecting an adapter, check that **Skill delivery** is enabled in the container's **Skills** tab. For guided setup, select **Set up skill delivery** there and copy the prompt into your coding agent.
</Callout>
...
Skill delivery does not send native agent runs to Automatic Learning. To collect new evidence, also [assign your Runtime's Threads to a container](/agno/learning#assign-threads-from-your-runtime).
...
`copilotkit skills download` remains supported for inspection, offline use, and unsupported frameworks. See the [Automatic Learning guide](/agno/learning) for the manual workflow.
