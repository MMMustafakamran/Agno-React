...
`copilotkit skills download` remains supported for inspection, offline use, and unsupported frameworks. See the [Learning guide](/agno/learning) for the manual workflow.
