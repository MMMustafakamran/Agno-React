...
// never says what sets it. Here it defaults to the Agno AgentOS AG-UI endpoint
// the main runtime uses, so the published line below runs unchanged.
process.env.AGENT_URL ??= process.env.AGNO_AGENT_URL ?? "http://localhost:8000/agui";
