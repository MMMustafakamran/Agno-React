...
const COMPONENTS: [string, string][] = [
  ...
  ["CopilotSidebar", "Docks to the side of the viewport. Adds `defaultOpen`, `width`, `position`."],
    ...
    <>
      ...
      <Panel title="What it demonstrates">
        ...
        <p className="mt-4 text-sm text-slate-600 dark:text-slate-400">
          In v2 all three come from{" "}
          <code className="rounded bg-slate-100 px-1.5 py-0.5 text-xs dark:bg-slate-800">
            @copilotkit/react-core/v2
          </code>{" "}
          — not the separate <code>@copilotkit/react-ui</code> package v1 used.
          That package is not a dependency of this repo at all.
        </p>
      ...
      <Panel
        title="Source"
        description="Note the tab switcher mounts one component at a time — sidebar and popup both use fixed positioning and would overlap."
      >
