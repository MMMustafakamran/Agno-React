 ...
 *
 * History replays here without CopilotKit Intelligence because the runtime
 * falls back to `InMemoryAgentRunner`, whose `connect()` replays a thread's
 * compacted events. That is the "persisting AgentRunner" case the page names,
 * scoped to the life of the runtime process.
 */
